// Package cli builds the ostep command tree.
package cli
...
import (
	...
	"github.com/tamnd/ostep-cli/ostep"
)
...
func Root() *cobra.Command {
	app := &App{cfg: ostep.DefaultConfig()}

	root := &cobra.Command{
		Use:           "ostep",
		Short:         "Browse the OSTEP textbook chapters from the command line",
		SilenceUsage:  true,
		SilenceErrors: true,
...
func (a *App) setup() error {
	...
	a.client = ostep.NewClient(a.cfg)
	return nil
}
