...
Most of these come down to network reality or how ostep serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ostep rate-limits like any public site. ostep already paces
...
Where a surface is gated, ostep reads a cookie or token you supply
...
`ostep`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ostep actually did
